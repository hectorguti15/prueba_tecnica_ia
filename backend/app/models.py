...
class Chat(Base):
    ...
    memory_summaries: Mapped[list["ChatMemorySummary"]] = relationship(
        back_populates="chat",
        cascade="all, delete-orphan",
        order_by="ChatMemorySummary.block_index",
    )
...
class ChatMemorySummary(Base):
    ...
    __table_args__ = (
        UniqueConstraint("chat_id", "block_index", name="uq_chat_memory_summary_block"),
    )
    ...
    chat: Mapped[Chat] = relationship(back_populates="memory_summaries")
